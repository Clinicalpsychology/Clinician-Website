...
export default function Home() {
  ...
  return (
    <main>
      ...
      <footer className="site-footer" id="contact"><div><a className="brand footer-brand" href="#top"><span className="brand-mark">+</span> mendwell</a><p>A gentler place to begin.</p></div><div className="footer-column"><p className="eyebrow">Contact</p><a href="tel:+254721650402">+254 721 650 402</a><a href="mailto:sam.clinicalpsychology@gmail.com">sam.clinicalpsychology@gmail.com</a></div><div className="footer-column"><p className="eyebrow">Stay connected</p><a href="https://web.facebook.com/psalm.chrisam/" target="_blank" rel="noreferrer">Facebook <span aria-hidden="true">↗</span></a><a href="https://www.instagram.com/alosisam/" target="_blank" rel="noreferrer">Instagram <span aria-hidden="true">↗</span></a></div></footer>
